# Generated by Django 4.2.6 on 2023-12-15 12:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_date', models.DateTimeField(default=django.utils.timezone.now, validators=[django.core.validators.MinValueValidator(limit_value=datetime.datetime(2023, 12, 15, 12, 42, 50, 735317, tzinfo=datetime.timezone.utc), message='Datetime must be in the future.')])),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('deadline_notif_sent', models.DateField(default=datetime.date(2023, 12, 14))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('users_to_invite', models.CharField(max_length=300)),
