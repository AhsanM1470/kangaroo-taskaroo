    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_date', models.DateTimeField(default=django.utils.timezone.now, validators=[django.core.validators.MinValueValidator(limit_value=datetime.datetime(2023, 12, 13, 16, 44, 55, 551880, tzinfo=datetime.timezone.utc), message='Datetime must be in the future.')])),
